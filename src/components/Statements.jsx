      ...
      <div className="bg-white rounded-lg shadow overflow-hidden mb-4">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredStatements.map((statement) => (
                    <tr key={statement._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                        {statement.openingPrice.toFixed(2)}
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
          ...
          <div className="overflow-x-auto">
            ...
            {filteredTransactions.length > 0 && (
              <Pagination
                ...
                paginate={(page) => paginate(page, setCurrentTransactionPage)}
                itemsPerPage={itemsPerPage}
                setItemsPerPage={setItemsPerPage}
        ...
        {activeTab === "manage" && (
          <div className="bg-white rounded-lg shadow overflow-hidden mt-2">
            <div className="bg-gradient-to-r from-blue-700 to-blue-500 text-white p-4">
              <h2 className="font-bold">Manage Deposits & Withdrawals</h2>
              <p className="text-xs opacity-80">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center">
                  <select
                    ...
                    className="rounded-md border border-gray-300 py-2 px-3 text-sm focus:ring-blue-500 focus:border-blue-500 flex-grow"
                  >
                ...
                <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="text-2xl font-bold text-gray-800">
                      {userBalances[transactionForm.userId]
                        ? `$${parseFloat(
                            userBalances[transactionForm.userId].cash
                          ).toFixed(2)}`
                        : "$0.00"}
                    </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="text-2xl font-bold text-gray-800">
                      {userBalances[transactionForm.userId]
                        ? `${parseFloat(
                            userBalances[transactionForm.userId].gold
                          ).toFixed(2)} oz`
                        : "0.00 oz"}
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
              ...
              {/* Transaction Management Cards */}
              {transactionForm.userId ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Cash Management Card */}
                  <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg border border-blue-100 p-6 shadow-sm">
                    ...
                    <p className="text-gray-600 mb-4">
                      Process cash deposits and withdrawals for{" "}
                      {transactionForm.userId}.
                    </p>
                    ...
                    <div className="flex space-x-3">
                      ...
                      <button
                        onClick={() => {
                          ...
                          // Pre-validate to show current balance if needed
                          if (
                            userBalances[transactionForm.userId] &&
                            parseFloat(
                              userBalances[transactionForm.userId].cash
                            ...
                            setBalanceError(
                              `Insufficient cash balance. Available: $${parseFloat(
                                userBalances[transactionForm.userId].cash
                              ).toFixed(2)}`
                            );
                          } else {
                        ...
                        className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded flex items-center justify-center"
                        disabled={
                          userBalances[transactionForm.userId] &&
                          parseFloat(
                            userBalances[transactionForm.userId].cash
                  ...
                  {/* Gold Management Card */}
                  <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg border border-yellow-100 p-6 shadow-sm">
                    <div className="flex items-center mb-4">
                    ...
                    <p className="text-gray-600 mb-4">
                      Process gold deposits and withdrawals for{" "}
                      {transactionForm.userId}.
                    </p>
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (
                            ...
                            setBalanceError(
                              `Insufficient gold balance. Available: ${parseFloat(
                                userBalances[transactionForm.userId].gold
                              ).toFixed(2)} oz`
                            );
                          } else {
                        ...
                        className="flex-1 bg-orange-600 hover:bg-orange-700 text-white py-2 rounded flex items-center justify-center"
                        disabled={
                          userBalances[transactionForm.userId] &&
                          parseFloat(
                            userBalances[transactionForm.userId].gold
                ...
                <div className="text-center p-8 text-gray-500">
                  ...
                  <p className="mt-1">
                    Please select a user to manage deposits and withdrawals
                  </p>
                </div>
              )}
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {transactionForm.userId
                        ? transactions
                            .filter((t) => t.userId === transactionForm.userId)
                            .slice(0, 3)
                            .map((transaction) => (
                              <tr
                                key={transaction.id}
